Rails.application.routes.draw do
  ...
  get 'immigration/antigua_barbuda_citizenship' => 'main#antigua_barbuda_citizenship'
  ...
  get 'immigration/st_kitts_nevis_citizenship' => 'main#st_kitts_nevis_citizenship'
